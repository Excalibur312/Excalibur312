<h1 align="center">Hi there, I'm Emre Kaya 👋</h1>
<p align="center">
...
- 📦 Interned at **World Medicine (2024)** as an **IT Software Intern**, developing internal C# automation tools
...
### 🔹 Hocavar  
> **Private tutoring & education platform (Startup-level project)**

- 🎓 Öğrenci–eğitmen eşleştirme sistemi  
...
### 🔹 WHMCS Clone (Backend-Focused)  
> **Hosting & billing automation system (WHMCS alternative)**

- 👤 Müşteri, bayi ve admin rol sistemi  
- 📦 Ürün / paket / servis yönetimi  
- 💳 Sipariş, faturalandırma ve ödeme akışları  
...
- 🧾 Yargıtay kararlarının PDF olarak scrape edilmesi  
...
> ASP.NET Web Forms + Stockfish integration

- ♟️ Drag & Drop taş hareketi (**Vanilla JS**)  
- ⏱️ Oyuncu bazlı süre yönetimi  
- 🔁 Hamle sonrası otomatik süre aktarımı  
- 🤖 **Stockfish.NET** ile gerçek zamanlı bot cevabı  
...
- 🗄️ SQL Server’a otomatik aktarım  
- 🔄 Tablo varsa update, yoksa insert  
- 📊 GridView ile canlı veri görüntüleme  
...
- 🚚 Araç ve konum yönetimi  
- 📄 PDF & Excel dosyalarının SQL’de saklanması  
- 👤 Session + yetki bazlı erişim kontrolü  

---

### 🔹 Python Neural Network – Score Predictor  

- 🧠 2 giriş (çalışma + uyku)  
- ⚙️ 1 gizli katman (ReLU)  
- 📈 Lineer çıkış  
- ❌ ML framework yok (NumPy ile manuel)  
...
- 📧 Email: [KayaEmreCE@gmail.com](mailto:KayaEmreCE@gmail.com)
